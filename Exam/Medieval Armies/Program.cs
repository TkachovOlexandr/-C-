...
//}
Console.WriteLine("\nBlue team:\n");
soldiers.Where(elem => elem.GroupNumber == 1).ToList().ForEach(elem => Console.WriteLine($"{elem.Name} ({elem.LocationX}, {elem.LocationY})"));
Console.WriteLine("\nRed team:\n");
soldiers.Where(elem => elem.GroupNumber == 2).ToList().ForEach(elem => Console.WriteLine($"{elem.Name} ({elem.LocationX}, {elem.LocationY})"));
